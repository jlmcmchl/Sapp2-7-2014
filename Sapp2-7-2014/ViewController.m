...
-(IBAction)Submit:(id)sender{
    int number = [[MatchNum text] intValue];
    number++;
    [MatchNum setText:[NSString stringWithFormat:@"%i",(int)number]];
    [TeamNum setText:[NSString stringWithFormat:@""]];
     NSLog(@"%g",Lowv);
       NSLog(@"%i",number);
